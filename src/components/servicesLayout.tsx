...
import OutdoorActivityBag from "@/assets/images/edited-photos/september-update/outdoor-activity-bag.webp";
import FacePaint from "@/assets/images/edited-photos/september-update/face-paint.webp";
import ServingWithPurpose from "@/assets/images/edited-photos/september-update/serving-with-purpose.webp";
import ClothesRack from "@/assets/images/edited-photos/september-update/clothes-rack.webp";
import OutdoorPrayer from "@/assets/images/edited-photos/september-update/outdoor-prayer.webp";
import OutdoorActivities from "@/assets/images/edited-photos/september-update/hope-and-wellness-fair.webp";

export default function ServicesLayout() {
  return (
    <div className="grid max-w-[900px] grid-cols-12 grid-rows-2 gap-2 px-8 md:px-0 font-quicksand-variable">
